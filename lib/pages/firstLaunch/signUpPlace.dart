...
//
                    ...
                    MySubmitBtn(
                      ...
                      toDo: () {
                        ...
                        Storge("placeName").savePref(_placeController.text);
                        Storge("phoneNumber").savePref(_phoneController.text);
                        Storge("city").savePref(_cityController.text);
                        Storge("governorate").savePref(_governorateController.text);
